...
The best way to set up your own server for Kubli is to download the ```server.py``` file, and point a tunnel or port forwarding configuration to ```YOUR_IP:13500```. Users and workers can then connect to that server.
